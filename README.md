...
| Prop                                                                                    |     Default      |      Type       | Description                                          |
| :-------------------------------------------------------------------------------------- | :--------------: | :-------------: | :--------------------------------------------------- |
| [DatePicker props](https://facebook.github.io/react-native/docs/datepicker#props)       |        -         |        -        | All DatePicker props (IOS only)                      |
| initDate                                                                                |   current date   |     `Date`      | Initial date                                         |
